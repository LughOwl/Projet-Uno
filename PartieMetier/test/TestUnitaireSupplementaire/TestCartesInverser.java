...
public class TestCartesInverser {
    private static Player alice, bob, charles;
    private static Game game = Game.getInstance();

    private static final Reverse redReverse = new Reverse(Color.RED);
    ...
    private static final Reverse greenReverse = new Reverse(Color.GREEN);
    ...
    @Test
    public void TestDeCoupsLegauxAvecDesCartesIverser() throws UnoException, PunishmentException {
        assertEquals(alice, game.getCurrentPlayer());
        alice.playCard(redReverse);
        alice.finishTurn();
        assertEquals(charles, game.getCurrentPlayer());
        assertEquals(redReverse, game.getDiscardPile().getTopCard());

        charles.playCard(greenReverse);
        charles.finishTurn();
        assertEquals(alice, game.getCurrentPlayer());
        assertEquals(greenReverse, game.getDiscardPile().getTopCard());
    ...
    @Test
    public void TestUneCarteSimpleIllegaleSurUnInverser() throws UnoException, PunishmentException {
        assertEquals(alice, game.getCurrentPlayer());
        alice.playCard(redReverse);
        alice.finishTurn();
    ...
    @Test
    public void TestUnInverserIllegalSurUneCarteSimple() throws UnoException, PunishmentException {
        assertEquals(alice, game.getCurrentPlayer());
        ...
        assertEquals(charles, game.getCurrentPlayer());
        assertEquals(3,charles.getHand().size());
        assertThrows(PunishmentException.class, () -> charles.playCard(greenReverse));
    }
}
