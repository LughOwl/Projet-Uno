...
public class Player {
     ...
     */
    public void finishTurn() throws UnoException, PunishmentException {
        checkRoundEnd();
        checkUnoViolation();
        checkPlayerMustPlay();
        checkWildColorSet();
     ...
     */
    public void punishment() throws UnoException, PunishmentException {
        this.addCard(Game.getInstance().removeCardDeck());
        this.addCard(Game.getInstance().removeCardDeck());
    ...
    private void checkRoundEnd() throws UnoException {
        if (Game.getInstance().getCurrentPlayer().getHand().isEmpty()) {
            throw new UnoException("The round is end");
        }
    }
