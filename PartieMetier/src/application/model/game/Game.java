...
import application.jdbc.DaoJoueur;
import application.jdbc.DaoParticipe;
import application.jdbc.DaoPartie;
...
//            DaoParticipe.enregistrerParticipation(DaoJoueur.getIdPlayer(player.getName()), idPartie, score);
     ...
     * from the draw pile. It ensures that each player starts with a full hand of cards for application.model.
     */
...
//     * based on their performance in the round and prepares for the next round of application.model.
//     *
//     * @throws UnoException If an error occurs during the round end process
//     */
