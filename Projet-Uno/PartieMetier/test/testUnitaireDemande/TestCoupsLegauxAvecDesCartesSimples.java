...
public class TestCoupsLegauxAvecDesCartesSimples{
    ...
    @Test
    public void AliceJoueUneCarteDeLaBonneCouleur() throws UnoException, PunishmentException {
        ...
        assertTrue(alice.getHand().contains(red1));
    ...
    @Test
    public void BobJoueUneCarteDeCouleurDifferenteMaisDeMemeValeur() throws UnoException, PunishmentException {
        AliceJoueUneCarteDeLaBonneCouleur();
        assertEquals(3, bob.getHand().size());
        bob.playCard(blue2);

        assertEquals(2, bob.getHand().size());

        assertTrue(bob.getHand().contains(yellow4));
        assertTrue(bob.getHand().contains(red9));

        assertEquals(blue2, game.getDiscardPile().getTopCard());
